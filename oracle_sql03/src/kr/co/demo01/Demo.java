...
public class Demo {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		/*
		 * Java 로 Oracle DB에 접속하여 데이터 조회하는 방법
		 * 	  1. JDBC 라이브러리 필수
		 * 	  		- JDBC 버전은 JDK 11인 경우 OJDBC 10이상을 사용.
		 * 	   		 JDK 8인 경우 OJDBC 8을 사용하면 됨
		 ...
		 * 		 D. Query 작성후 전송
		 * 		 E. 작성한 Query 를 전송 후 ResultSet반환
		 * 		 F. 반환 받은 ResultSet의 내용 추출 및 추가 작업
