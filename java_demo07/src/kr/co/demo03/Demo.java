...
public class Demo {
	...
	public static void main(String[] args) {
		/*
		 * 다형성 - 객체지향 프로그램 언어의 3가지 특징(캡슐화, 상속, 다형성) - 하나의 객체가 여러 형태를 가진다는 의미 - 상속을 사용하여
		 * 부모 타입으로부터 파생된 여러 타입의 자식 객체를 부모 클래스로 다룰 수 있도록 한다.
		 * 
		 */
...
//		p2.setPoint();
		/*
		 * 다운 캐스팅 - 부모 객체로 사용하고 있는 인스턴스를 자식 객체로 변환하는 것 - 명시적으로 작성하여 캐스팅이 이루어지게 해야한다.(캐스팅
		 * 연산 사용)
		 * 
		 * 업 캐스팅 - 자식 객체로 사용하고 있는 인스턴스를 부모 객체로 변환하는 것 - 자동으로 변환이 이루어진다.
		 */
...
//		System.out.println(p2);
		...
		/*
		 * 배열에 다형성을 적용하여 서로 다른 자식 객체를 담아 사용할 수 있다. 물론 동일한 부모객체를 상속해야 한다.
		 */
