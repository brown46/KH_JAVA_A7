...
public class Demo {
	...
	public static void main(String[] args) {
		/*
		 * 인터페이스 추상 클래스 처럼 미완성된 클래스라고 볼 수 있으나 다른점은 모든 메서드가 추상 메서드이고 멤버변수는 오직 상수만을 가질 수
		 * 있다.
		 * 
		 * - 모든 메서드는 암묵적으로 public abstract이다. - 멤버 변수는 암묵적으로 public static final이다. - 참조
		 * 타입으로만 사용할 수 있으며, 객체 생성에 사용할 수 없다. - implements 키워드를 사용하여 적용한다. - 1개 이상의
