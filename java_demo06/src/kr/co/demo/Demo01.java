...
public class Demo01 {
	...
	public static void main(String[] args) {
		 ...
		 * 		요구하는 "국민" 이라는 한 사람의 정보를 객체회(추상화) 한다면.
		 * 
...
//		phone1.number="010-4567-8934";
		
		/*
		 * 생성자
		 * 		new 연산자를 통해 객체가 인스턴스로 만들어 질 때 
		 * 		객체 안에서 만들어지는 멤버변수를 초기화 하기 위한	메서드
		...
		/*
		 * getter/setter메서드
		 * 	 	getter메서드는 멤버 변수의 값을 변환시켜주는 메서드이다.
		 * 		setter메서드는 멤버변수에 데이터를 설정하기 위해 사용하는 메서드
		 * 
		 * 
		 */
		Smartphone phone2= new Smartphone();
		phone2.setBrand("삼성 갤럭시 노트");
		phone2.setModel("BMS-4725");
		phone2.setNumber("010-2324-5456");
