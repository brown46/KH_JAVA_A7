...
CREATE TABLE 가계부(
	   ID  VARCHAR2(10 CHAR)
	 , 입금출금구분 CHAR(1 CHAR) CHECK(입금출금구분 IN('I','O'))
	 , 금액 NUMBER
	 , 날짜 DATE
	 , 지출구분 VARCHAR2(10 CHAR) REFERENCES 지출구분(항목)
...
INSERT INTO 가계부 VALUES('4-T1','O',2000,TO_DATE(20220424),'교통비','하원');
INSERT INTO 가계부 VALUES('4-P','O',44000,TO_DATE(20220424),'통신비','');

INSERT INTO 가계부 VALUES('5-F1','O',6000,TO_DATE(20220525),'식비','저녁');
INSERT INTO 가계부 VALUES('5-F1','O',4000,TO_DATE(20220525),'식비','군것질');
INSERT INTO 가계부 VALUES('5-T1','O',2000,TO_DATE(20220525),'교통비','등원');
INSERT INTO 가계부 VALUES('5-T1','O',2000,TO_DATE(20220525),'교통비','하원');
INSERT INTO 가계부 VALUES('4-P','O',49000,TO_DATE(20220525),'통신비','');

INSERT INTO 가계부 VALUES('6-F1','O',9000,TO_DATE(20220627),'식비','외식');
INSERT INTO 가계부 VALUES('6-T1','O',2000,TO_DATE(20220627),'교통비','등원');
INSERT INTO 가계부 VALUES('6-T1','O',2000,TO_DATE(20220627),'교통비','하원');
INSERT INTO 가계부 VALUES('7-P','O',42000,TO_DATE(20220627),'통신비','');

INSERT INTO 가계부 VALUES('7-F1','O',14000,TO_DATE(20220728),'식비','외식');
INSERT INTO 가계부 VALUES('7-T1','O',8000,TO_DATE(20220728),'교통비','등원');
INSERT INTO 가계부 VALUES('7-T1','O',8000,TO_DATE(20220728),'교통비','하원');
...
INSERT INTO 가계부 VALUES('8-T1','O',8000,TO_DATE(20220829),'교통비','하원');
...
INSERT INTO 가계부 VALUES('9-T1','O',8000,TO_DATE(20220930),'교통비','하원');
...
INSERT INTO 가계부 VALUES('10-T1','O',8000,TO_DATE(20221031),'교통비','하원');
...
INSERT INTO 가계부 VALUES('11-T5','O',2000,TO_DATE(20221104),'교통비','등원');
INSERT INTO 가계부 VALUES('11-T6','O',2000,TO_DATE(20221104),'교통비','하원');
INSERT INTO 가계부 VALUES('11-E1','O',3000,TO_DATE(20221104),'교육비','용품');

INSERT INTO 가계부 VALUES('11-F5','O',4000,TO_DATE(20221108),'식비','군것질');
INSERT INTO 가계부 VALUES('11-T7','O',2000,TO_DATE(20221108),'교통비','등원');
INSERT INTO 가계부 VALUES('11-T8','O',2000,TO_DATE(20221108),'교통비','하원');

INSERT INTO 가계부 VALUES('11-F6','O',13000,TO_DATE(20221109),'식비','저녁');
INSERT INTO 가계부 VALUES('11-T9','O',2000,TO_DATE(20221109),'교통비','등원');
INSERT INTO 가계부 VALUES('11-T10','O',2000,TO_DATE(20221109),'교통비','하원');
...
INSERT INTO 가계부 VALUES('11-T11','O',2000,TO_DATE(20221115),'교통비','등원');
INSERT INTO 가계부 VALUES('11-T12','O',2000,TO_DATE(20221115),'교통비','하원');
